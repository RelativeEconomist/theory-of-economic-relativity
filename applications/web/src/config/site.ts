export const siteConfig = {
  ...
  title: "Theory of Economic Relativity — A proposed framework for economic decision-making",
  description:
    "Theory of Economic Relativity (TER) is an open, testable architecture for economic decision-making, interaction, and outcomes, supported by a versioned research framework and executable replication tests.",
